...
if (! $json) {
    ...
    $results['service_urls']['Equipment tutorial'] = 'https://itconnect.uw.edu/tools-services-support/teaching-learning/classroom-technology-support/equipment-tutorials/';
